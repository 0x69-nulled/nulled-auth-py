...
VERSION = '1.7.5'
DESCRIPTION = 'nulled.to release authentication package for python'
LONG_DESCRIPTION = """# Nulled.to releases authentication module for python
...
setup(
  ...
  version=VERSION,
  author="0x69",
  author_email="nulled0x69@protonmail.com",
  ...
  keywords=['python', 'authentication', 'nulled', 'release'],
  python_requires='>=3',
  classifiers=[
